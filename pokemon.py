...
class PokemonFactory:
    ...
    def create(
        ...
        with open(self._src_file, "r") as c:
            ...
            """ El operador * se utiliza para desempaquetar los valores de la lista. 
            En este caso, desempaqueta los valores de poke["stats"] y los pasa como argumentos a la clase Stats.
            """
            new_pokemon = Pokemon(
            ...
            """
                ...
                no mutable     catch_rate: int,            # Dificultad de captura. (Min: 0, Max: 25
